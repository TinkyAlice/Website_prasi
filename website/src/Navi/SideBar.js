...
import IconST from '../Bilder/IconST-Fontaine-200x-200x.png'
      ...
      {showSidebar ? (
        ...
        <div class="flex flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-gray-900 rounded z-50">
          <a class="flex items-center justify-center mt-3" href="#">
            <svg onClick={() => setShowSidebar(!showSidebar)} class="w-8 h-8 fill-current" xmlns="{IconST}" viewBox="0 0 20 20" fill="currentColor">
              <path d="M319 1563 c-13 -16 -12 -17 4 -4 9 7 17 15 17 17 0 8 -8 3 -21 -13z" />
            </svg>
          </a>
